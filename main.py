...
# Dummy client credentials (temporary test keys)
...
# Login route to authenticate and generate tokens
@app.post("/login")
...
# Extract current user from token (token validation)
